...
The real power of group validation comes when you apply custom validation rules
to your specific scenario. Adding a custom validation rule to a group gives you
...
---------------|----------------------------------------------------------------
`default`      | Anything in the default slot will be considered part of the group, and become `repeatable` if applicable.
